...
ffuf -u W2/W1 -w $fuzz:W1,/new-$target/validsubdomain-$target.txt:W2 -fc 204,301,302,307,401,403,405,500 -fs 0 -acc www | tee new-$target/ffufresult1

echo -e "\e[1;34m [+] Running ffuf on validsubdomain POST based \e[0m"
ffuf -X POST -u W2/W1 -w $fuzz:W1,/new-$target/validsubdomain-$target.txt:W2 -fc 204,301,302,307,401,403,405,500 -fs 0 -acc www | tee new-$target/ffufresult2
